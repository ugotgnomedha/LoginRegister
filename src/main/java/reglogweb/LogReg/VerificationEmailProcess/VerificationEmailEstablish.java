package reglogweb.LogReg.VerificationEmailProcess;

import reglogweb.LogReg.LoginForm;
import reglogweb.LogReg.RegisterForm;
...
public class VerificationEmailEstablish {
    ...
    private static Boolean runVerification(String verificationCode) {
        ...
        try {
            Connection connection = DriverManager.getConnection(ConfigGetter.urlDB, ConfigGetter.userDB, ConfigGetter.passwordDB);
