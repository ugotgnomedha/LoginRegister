package reglogweb.LogReg.RegisterProcess;
...
public class RegisterEstablish {
    ...
    private static Boolean runConnectionRegister(String email, String password, String userName) {
        ...
        try {
            ...
            Connection registerConn = DriverManager.getConnection(ConfigGetter.urlDB, ConfigGetter.userDB, ConfigGetter.passwordDB);
